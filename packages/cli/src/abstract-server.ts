...
export abstract class AbstractServer {
	...
	async start(): Promise<void> {
		...
		if (this.webhooksEnabled) {
			...
			this.app.all(`/${this.endpointForm}/:path{/*rest}`, liveWebhooksRequestHandler);

			// Register a handler for live webhooks
			this.app.all(`/${this.endpointWebhook}/:path{/*rest}`, liveWebhooksRequestHandler);
		...
		if (this.testWebhooksEnabled) {
			...
			// Register a handler
			this.app.all(`/${this.endpointFormTest}/:path{/*rest}`, testWebhooksRequestHandler);
			this.app.all(`/${this.endpointWebhookTest}/:path{/*rest}`, testWebhooksRequestHandler);
		}
